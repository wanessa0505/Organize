                ...
                <section>
                    <div class="activity-grid">
                        <div class="activity-card">
                            ...
                            <p>Para criar uma nova anotação em seu planner, basta apenas preencher os campos abaixo e
                                selecionar o botão "criar anotação"</p>
                                ...
                                <form action="{{ route('add-anotacao-store') }}" method="POST">
                                    ...
                                    <div class="input-box message-box">
                                        <textarea class="textarea" id="descricao" name="descricao"
                                            placeholder="Descrição da anotação"></textarea> <br>
                                    </div>
                                    <div class="button">
